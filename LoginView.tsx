    ...
    return (
        <div className="min-h-screen bg-gray-900 flex font-sans">
            ...
            <div className="hidden lg:flex w-1/2 bg-gray-800 items-center justify-center relative">
                <img 
                    src={siteSettings.login_image_url || "https://images.unsplash.com/photo-1603525281789-b5f3a1f1a1d3?q=80&w=2574&auto=format&fit=crop"} 
                ...
                <div className="relative z-10 text-center p-12">
                     <div className="flex items-center justify-center mb-4">
                        {siteSettings.logo_url && (
                            <img src={siteSettings.logo_url} alt={siteSettings.academy_name} className="max-h-24 w-auto mr-4" />
                        )}
                        <h1 className={`font-bold text-red-600 ${siteSettings.logo_url ? 'text-4xl' : 'text-5xl'}`}>{siteSettings.academy_name}</h1>
                    </div>
