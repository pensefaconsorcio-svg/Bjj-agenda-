...
const BookingView: React.FC = () => {
    ...
    const [confirmingBooking, setConfirmingBooking] = useState<Omit<Booking, 'id' | 'user_id' | 'user_email' | 'status' | 'booking_key'> | null>(null);
                                        ...
                                        {booking ? (
                                            <div className="flex items-center space-x-3">
                                                {booking.status === 'pending' ? (
                                                    isAdminOrMestre ? (
                                                        <>
                                                            <div className="text-right"><span className="text-sm text-yellow-500 font-semibold truncate" title={booking.user_email}>{booking.user_email}</span></div>
                                                    ...
                                                    <>
                                                        <div className="text-right">
                                                            ...
                                                            <p className="text-xs text-gray-400 truncate" title={booking.user_email}>{booking.user_email}</p>
                                                        </div>
