    ...
    <div className="flex flex-col h-full bg-gray-800 border-r border-gray-700 p-4">
      ...
      >
        {siteSettings.logo_url ? (
          <img src={siteSettings.logo_url} alt={siteSettings.academy_name} className={`max-h-full transition-all duration-300 ${isCollapsed ? 'w-auto' : 'w-auto mr-3'}`} />
        ) : (
